...
LDLIBSOPTIONS=../Antik/dist/Debug/GNU-Linux/libantik.a -lboost_system -lboost_filesystem -lboost_program_options `pkg-config --libs libcurl` `pkg-config --libs zlib` `pkg-config --libs openssl` -lpthread   

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/escapement

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/escapement: ../Antik/dist/Debug/GNU-Linux/libantik.a
