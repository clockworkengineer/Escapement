...
${OBJECTDIR}/Escapement.o: Escapement.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation `pkg-config --cflags libcurl` `pkg-config --cflags zlib` `pkg-config --cflags openssl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Escapement.o Escapement.cpp

${OBJECTDIR}/Escapement_CommandLine.o: Escapement_CommandLine.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation `pkg-config --cflags libcurl` `pkg-config --cflags zlib` `pkg-config --cflags openssl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Escapement_CommandLine.o Escapement_CommandLine.cpp

${OBJECTDIR}/Escapement_FileCache.o: Escapement_FileCache.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation `pkg-config --cflags libcurl` `pkg-config --cflags zlib` `pkg-config --cflags openssl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Escapement_FileCache.o Escapement_FileCache.cpp

${OBJECTDIR}/Escapement_Files.o: Escapement_Files.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation `pkg-config --cflags libcurl` `pkg-config --cflags zlib` `pkg-config --cflags openssl` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Escapement_Files.o Escapement_Files.cpp
